...
public class FirefoxSendFormVehicleTests extends SendFormVehicleTests {
    private static final Logger log = Logger.getLogger(FirefoxSendFormVehicleTests.class);
