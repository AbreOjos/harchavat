...
public class ChromeSendFormRealEstateTests extends SendFormRealEstateTests {
    private static final Logger log = Logger.getLogger(ChromeSendFormRealEstateTests.class);
