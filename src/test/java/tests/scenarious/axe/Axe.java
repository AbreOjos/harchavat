...
public class Axe {
	 ...
	 */
	private static void inject(final WebDriver driver, final URL scriptUrl, Boolean skipFrames) {
	...
	public static void writeResults(final String name, final Object output) {
		...
		try (Writer writer = new BufferedWriter(
				new OutputStreamWriter(
						new FileOutputStream(name + ".json"), StandardCharsets.UTF_8))) {
	...
	public static class AxeRuntimeException extends RuntimeException {
		...
		AxeRuntimeException(String message) {
			super(message);
		}
	}
